...
<html>
    ...
    <title>Indusface Vulnerable Web Application!</title>
  </head>
  <body>
    <div class="container " style="border: 2px solid #5c95cf;">
      <div class="column span-24 first last">
	<h1 id="title"><a href="/home.php?home=index.php"><br><center>Indusface Total Application Security!</center><br></a></h1>
      </div>
      <div id="menu">
	<div class="column prepend-1 span-14 first">
	  <ul class="menu">
        ...
        <li class="<?php if($selected == "download"){ echo 'current'; } ?>"><a href="/down.php"><span>Download</span></a></li>
        <li class="<?php if($selected == "about"){ echo 'current'; } ?>"><a href="/view.php?page=about.html"><span>About</span></a></li>
      ...
      <div class="column span-24 first last" id="search_bar_blue">
		<div class="column prepend-17 span-7 first last" id="search_box">
		  <form action="/pictures/search.php" method="get" style="display:inline;">
		    <input id="query2" name="query" size="15" style="padding: 2px; font-size: 16px; text-decoration:none;border:none;vertical-align:middle;" type="text" value="<?php echo h($search_terms) ?>"/>
...
function our_footer()
{
   ?>
	...
	<ul>
	  ...
	  <li><a href="mailto:info@indusface.com">Contact</a> |</li>
...
?>
<li>
<a href="<?php echo h( $link_to . "picid=" . $pic['id'] ) ?>"><img src="/upload/<?php echo h( $pic['filename']) ?>.128_128.jpg" height="128" width="128" /></a>
</li>
<?php
